window.addEventListener("load", () => {
  ...
  async function appenddata() {
    try {
      let responsedata = await fetch("https://express-clone-backend.onrender.com/carts/get",{
        headers:{
  ...
  async function decrement(id){
        console.log(id)
    let responsedata = await fetch(`https://express-clone-backend.onrender.com/carts/dec/${id}`,{
        method:"PATCH",
        headers: {
            "Authorization":localStorage.getItem("token")
        }
  ...
  async function increment(id){
    console.log(id)
let responsedata = await fetch(`https://express-clone-backend.onrender.com/carts/inc/${id}`,{
    method:"PATCH",
    headers: {
        "Authorization":localStorage.getItem("token")
    }
...
async function removed(id){
    ...
    let responsedata = await fetch(`https://express-clone-backend.onrender.com/carts/delete/${id}`,{
        method:"DELETE",
        headers: {
            "Authorization":localStorage.getItem("token")
        }
